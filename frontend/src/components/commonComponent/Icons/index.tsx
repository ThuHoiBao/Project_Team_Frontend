...
export const CartIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8 8C6.89543 8 6 8.89543 6 10C6 11.1046 6.89543 12 8 12H10.4629L13.0629 26.4C13.2691 27.4636 14.173 28.2 15.2629 28.2H35.7371C36.827 28.2 37.7309 27.4636 37.9371 26.4L40.5371 12.4C40.6777 11.6264 40.1523 10.8 39.3371 10.8H14.5371L14.0629 8.4C13.8567 7.33639 12.9528 6.6 11.8629 6.6H8C8 6.6 8 8 8 8ZM16.0963 14.4H37.3037L35.2037 24.6H16.7963L16.0963 14.4Z"
    />
